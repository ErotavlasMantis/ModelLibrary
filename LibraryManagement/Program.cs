    ...
    public static void Main(string[] args)
    {
        ...
        switch (input)
        {
            case "1":
                ...
                {
                    Console.WriteLine("Premi 1 per prenotare un libro, 2 per cercare un libro, 3 per visualizzare la lista, 4 per verificare le tue prenotazioni attive, premi 5 per restituire un libro");
                    input = Console.ReadLine();
                    switch (input)
                    {
                        case "1":
